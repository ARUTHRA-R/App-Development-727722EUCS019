  ...
  return (
    ...
    <div className="font-serif flex flex-col dark:text-white bg-white dark:bg-gray-900">
      ...
      <div className="flex flex-col w-full mx-auto px-10">
        ...
        <div className="flex  rounded-lg w-full mx-auto h-48 py-5 bg-gradient-to-r from-purple-600 to-emerald-700">
          </div>
          ...
          <div className="border rounded-md h-10 w-48 my-auto relative top-3 bg-white ">
            <h1 className="text-purple-600 font-medium my-2">Your Pack: {planData.planName}</h1>
          </div>
          <div className="border rounded-md h-10 w-48 my-auto relative top-3 bg-white">
            <h1 className="text-purple-600 font-medium my-2">Data : {planData.planData} GB/Day</h1>
          </div>
          <div className="border rounded-md h-10 w-48 my-auto relative top-3 bg-white">
            <h1 className="text-purple-600 font-medium my-2">SMS : {planData.planSms}</h1>
          </div>
          <div className="border rounded-md h-10 w-48 my-auto relative top-3 bg-white">
            <h1 className="text-purple-600 font-medium my-2">Next recharge : {planData.planValidity} Days</h1>
          </div>
          </div>
          {/* <div className="  p-4 ">
