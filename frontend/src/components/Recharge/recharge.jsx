  ...
  const Recharge = () => {
    ...
    return (
      <div className='w-fit flex flex-col font-serif dark:bg-gray-900 bg-white'>
        ...
        <div className='py-3'>
          <div>
            <h2 className='text-2xl font-bold text-purple-500 dark:text-white'>1 GB/Day plan:</h2>
          </div>
          <div className='py-2'>
        ...
        <div className='py-3'>
          <div>
            <h2 className='text-2xl font-bold text-purple-500 dark:text-white'>1.5 GB/Day plan:</h2>
          </div>
          <div className='py-2'>
        ...
        <div className='py-3'>
          <div>
            <h2 className='text-2xl font-bold text-purple-500 dark:text-white'>2 GB/Day plan:</h2>
          </div>
          <div className='py-2'>
