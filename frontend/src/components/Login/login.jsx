        ...
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
            ...
            <div className="mb-5">
              ...
              }}   type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"  />
            </div>
            <div className="flex items-start mb-5">
              <div className="flex items-center h-5">
                <input id="remember" type="checkbox" value="" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-purple-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-purple-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800"  />
              </div>
            ...
            <button onClick={(e) => handleLogin(e)} type="submit" className="text-white bg-churn hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm w-full sm:w-auto px-7 py-2 mt-2 text-center dark:bg-churn dark:hover:bg-purple-700 dark:focus:ring-purple-800">Login</button>
